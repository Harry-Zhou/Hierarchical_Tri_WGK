...
class GraphClassification(object):
    ...
    def svc_classify(self, x, y, search):
        ...
        return np.mean(accuracies), np.mean(accuracies), np.mean(roc_auc_scores)
...
if __name__ == "__main__":
    ...
    with open(os.path.join('.', 'gc_results', args.dataset + '_results.csv'), 'w', newline = '', encoding = 'utf-8') as fout:
