...
if __name__ == '__main__':
    ...
    # Step 1: Prepare data =================================================================== #
    if args.dataname in ['reddit', 'cora_full', 'pubmed', 'amazon', 'mutag', 'coauthor', 'ppi']:
        graph, diff_graph, feat, label, train_idx, val_idx, test_idx, edge_weight = process_dataset_appnp(args.dataname, args.epsilon)
    else:
