...
- **vs PCB-GNN**：多层抽象 + 双向信息流 + 严格理论保证
- **vs GraphGPS/Exphormer**：圈空间利用 + HTN-WL 对齐
- **vs HOGT**：更精确的理论保证 + 更清晰的圈空间编码

CSG‑Transformer 为图深度学习提供了兼具理论保障与实用性的新方案。未来工作将聚焦于：近似圈基算法以降低构建开销、归纳式设计以扩展应用场景、以及异质图支持以拓宽应用领域。
