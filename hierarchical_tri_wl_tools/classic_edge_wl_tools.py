...
def update_elabel(
    ...
    elabel_collection1 = collect_vlabels(vlabel_np1, elabel_dict1)
    elabel_collection2 = collect_vlabels(vlabel_np2, elabel_dict2)
...
def classic_edge_WL_test(
    ...
    edge_compressed_label1, edge_compressed_label2 = dict(zip(edges1, elabel_np1)), dict(zip(edges2, elabel_np2))
    for i in range(1, niter + 1):
        vlabel_collection1 = propagate_vlabel_from_edges(
            node_neighs_dict1, vwl_np1[:, i - 1], edge_compressed_label1)
        vlabel_collection2 = propagate_vlabel_from_edges(
            node_neighs_dict2, vwl_np2[:, i - 1], edge_compressed_label2)
        ...
        edge_compressed_label1, edge_compressed_label2 = update_elabel(
            temp_vlabel_np1, temp_vlabel_np2, 
            edge_compressed_label1, edge_compressed_label2
        )
        for eidx1, e1 in enumerate(edges1):
            ewl_np1[eidx1, i] = edge_compressed_label1[e1]
        for eidx2, e2 in enumerate(edges2):
            ewl_np2[eidx2, i] = edge_compressed_label2[e2]
        
    return vwl_np1, vwl_np2, ewl_np1, ewl_np2

def gdv_edge_WL_test(
    dataset_info, niter, 
    g1, g2, 
    gdv1, gdv2, 
    ...
    if dataset_info['nl'] and dataset_info['el']:
        ...
        # edge labeled
        wl_np1[:, :, 0], wl_np2[:, :, 0], ewl_np1, ewl_np2 = classic_edge_WL_test(
            g1, g2, 
            vlabel_np1, vlabel_np2, 
            edges1, edges2, 
            elabel1, elabel2, 
    ...
    return wl_np1, wl_np2, ewl_np1, ewl_np2
...
if __name__ == '__main__':
    ...
    wl_np1, wl_np2 = classic_edge_WL_test(
        g1, 
        g2, 
        vlabel_np1, 
        vlabel_np2, 
